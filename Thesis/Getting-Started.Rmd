...
You can embed R code within normal text to create dynamic reports. For example, if you write \` r nrow(cars) \`, this will be printed out as `r nrow(cars)`.

E.g. There were `r nrow(cars)` cars in the dataset.
